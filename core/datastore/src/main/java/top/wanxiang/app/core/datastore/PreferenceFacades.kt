...
class RuntimePreferences @Inject constructor(private val store: SettingsDataStore) {
    ...
    suspend fun setExecutionMode(value: top.wanxiang.app.core.model.ExecutionMode) = store.setExecutionMode(value)
    suspend fun setPreferredExecutionMode(value: top.wanxiang.app.core.model.ExecutionMode) = store.setPreferredExecutionMode(value)
    suspend fun setEffectiveExecutionMode(value: top.wanxiang.app.core.model.ExecutionMode) = store.setEffectiveExecutionMode(value)
